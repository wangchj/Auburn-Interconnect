<%@ Page Title="" Language="C#" MasterPageFile="~/admin/Events/AdminEvents.master" AutoEventWireup="true" CodeBehind="DeclinedEvents.aspx.cs" Inherits="AUInterconnect.Views.admin.Events.DeclinedEvents" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
        ...
        SelectCommand="SELECT Events.eventId, Events.eventName, Users.fname + ' ' + Users.lname AS proposedBy, Events.hostName, Events.startTime FROM Events INNER JOIN Users AS Users ON Events.creatorId = Users.uid WHERE (Events.approved = 0) AND (Events.declined = 1) ORDER BY Events.startTime DESC">
    </asp:SqlDataSource>
</asp:Content>
